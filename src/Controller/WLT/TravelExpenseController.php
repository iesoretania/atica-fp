...
/**
 * @Route("/dual/desplazamiento")
 */
class TravelExpenseController extends AbstractController
{
    /**
     * @Route("/nuevo/{id}", name="work_linked_training_travel_expense_new",
    ...
    /**
     * @Route("/detalle/{id}", name="work_linked_training_travel_expense_edit",
     *     requirements={"id" = "\d+"}, methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}/listar/{page}", name="work_linked_training_travel_expense_detail_list",
    ...
    /**
     * @Route("/resumen/{academicYear}/{page}", name="work_linked_training_travel_expense_teacher_list",
    ...
    /**
     * @Route("/eliminar/{id}", name="work_linked_training_travel_expense_operation",
    ...
    /**
     * @Route("/{id}/descargar",
     *     requirements={"id" = "\d+"}, name="work_linked_training_travel_expense_report", methods={"GET"})
     */
