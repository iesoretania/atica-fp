...
use App\Entity\WptModule\TravelExpense;
use App\Form\Type\WptModule\TravelExpenseType;
use App\Repository\Edu\AcademicYearRepository;
use App\Repository\Edu\TeacherRepository;
use App\Repository\WptModule\AgreementRepository;
use App\Repository\WptModule\TravelExpenseRepository;
...
use App\Security\WptModule\TravelExpenseVoter;
...
class TravelExpenseController extends AbstractController
{
    ...
    public function list(
        ...
        $title = $teacher->__toString() . ' - ' . $translator->trans('title.list', [], 'wpt_travel_expense');
    ...
    public function teacherList(
        ...
        $person = $this->getUser();
        if (!$isManager) {
            $teachers = [$teacherRepository->findOneByPersonAndAcademicYear($person, $academicYear)];
        } else {
    ...
    #[Route(path: '/{id}/descargar', name: 'workplace_training_travel_expense_report', requirements: ['id' => '\d+'], methods: ['GET'])]
