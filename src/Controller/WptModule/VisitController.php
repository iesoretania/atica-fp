...
use App\Entity\WptModule\Contact;
use App\Form\Type\WptModule\VisitType;
use App\Repository\Edu\AcademicYearRepository;
use App\Repository\Edu\TeacherRepository;
use App\Repository\WptModule\ContactRepository;
...
{
    #[Route(path: '/nueva/{id}', name: 'workplace_training_visit_new', requirements: ['id' => '\d+'], methods: ['GET', 'POST'])]
    public function new(
        Request              $request,
    ...
    public function index(
        ...
        $breadcrumb = [
            [
                'fixed' => $visit->getTeacher()->__toString(),
    ...
    public function list(
        ...
        $title = $teacher->__toString() . ' - ' . $translator->trans('title.list', [], 'wpt_visit');
    ...
    #[Route(path: '/{id}/descargar', name: 'workplace_training_visit_report', requirements: ['id' => '\d+'], methods: ['GET'])]
