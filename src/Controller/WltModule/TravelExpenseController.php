...
use App\Entity\WltModule\TravelExpense;
use App\Form\Type\WltModule\TravelExpenseType;
...
class TravelExpenseController extends AbstractController
{
    ...
    public function list(
        ...
        $title = $teacher->__toString() . ' - ' . $translator->trans('title.list', [], 'wlt_travel_expense');
    ...
    #[Route(path: '/{id}/descargar', name: 'work_linked_training_travel_expense_report', requirements: ['id' => '\d+'], methods: ['GET'])]
