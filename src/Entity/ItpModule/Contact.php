...
class Contact
{
     ...
     */
    #[ORM\ManyToMany(targetEntity: TrainingProgram::class)]
    #[ORM\JoinTable(name: 'itp_contact_training_program')]
    ...
    #[ORM\JoinTable(name: 'itp_contact_student_enrollment')]
    ...
    public function setTrainingPrograms(Collection $trainingPrograms): static
    {
