...
class WltModule implements ModuleBuilderInterface
{
    ...
    public function getMenuStructure(): array
    {
        ...
        if ($this->security->isGranted(OrganizationVoter::WLT_ACCESS, $organization)) {
            $menu1 = new MenuItem();
            $menu1
            ...
            if ($this->security->isGranted(OrganizationVoter::WLT_MANAGE, $organization)) {
                $menu2 = new MenuItem();
                $menu2
            ...
            if ($this->security->isGranted(OrganizationVoter::WLT_VIEW_EVALUATION, $organization)) {
                $menu2 = new MenuItem();
                $menu2
            ...
            if ($this->security->isGranted(OrganizationVoter::WLT_VIEW_GRADE, $organization)) {
                $menu2 = new MenuItem();
                $menu2
            ...
            if ($this->security->isGranted(OrganizationVoter::WLT_ACCESS_VISIT, $organization)) {
                $menu2 = new MenuItem();
                $menu2
            ...
            if ($this->security->isGranted(OrganizationVoter::WLT_ACCESS_EXPENSE, $organization)) {
                $menu2 = new MenuItem();
                $menu2
            ...
            if ($this->security->isGranted(OrganizationVoter::WLT_MANAGER, $organization) ||
                $this->security->isGranted(OrganizationVoter::WLT_DEPARTMENT_HEAD, $organization) ||
                $this->security->isGranted(OrganizationVoter::WLT_GROUP_TUTOR, $organization) ||
