...
class WptModule implements ModuleBuilderInterface
{
    ...
    public function getMenuStructure(): array
    {
        ...
        if ($this->security->isGranted(OrganizationVoter::WPT_ACCESS_SECTION, $organization)) {
            $menu1 = new MenuItem();
            $menu1
            ...
            if ($this->security->isGranted(OrganizationVoter::WPT_MANAGER, $organization)) {
                $menu2 = new MenuItem();
                $menu2
            ...
            if ($this->security->isGranted(OrganizationVoter::WPT_ACCESS, $organization)) {
                $menu2 = new MenuItem();
                $menu2
            ...
            if ($this->security->isGranted(OrganizationVoter::WPT_FILL_REPORT, $organization)) {
                $menu2 = new MenuItem();
                $menu2
            ...
            if ($this->security->isGranted(OrganizationVoter::WPT_ACCESS_VISIT, $organization)) {
                $menu2 = new MenuItem();
                $menu2
            ...
            if ($this->security->isGranted(OrganizationVoter::WPT_ACCESS_EXPENSE, $organization)) {
                $menu2 = new MenuItem();
                $menu2
            ...
            if ($this->security->isGranted(OrganizationVoter::WPT_MANAGER, $organization) ||
                $this->security->isGranted(OrganizationVoter::WPT_DEPARTMENT_HEAD, $organization) ||
                $this->security->isGranted(OrganizationVoter::WPT_EDUCATIONAL_TUTOR, $organization) ||
                $this->security->isGranted(OrganizationVoter::WPT_GROUP_TUTOR, $organization) ||
                $this->security->isGranted(OrganizationVoter::WPT_STUDENT, $organization)
            ) {
                $menu3 = new MenuItem();
                $menu3
            ...
            if ($this->security->isGranted(OrganizationVoter::WPT_MANAGER, $organization) ||
                ...
                $this->security->isGranted(OrganizationVoter::WPT_GROUP_TUTOR, $organization) ||
                $this->security->isGranted(OrganizationVoter::WPT_EDUCATIONAL_TUTOR, $organization) ||
                $this->security->isGranted(OrganizationVoter::WPT_WORK_TUTOR, $organization)
            ) {
                $menu3 = new MenuItem();
                $menu3
