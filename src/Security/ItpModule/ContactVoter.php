...
{
    public const MANAGE = 'ITP_CONTACT_MANAGE';
    public const ACCESS = 'ITP_CONTACT_ACCESS';
            ...
            case self::ACCESS:
                ...
                foreach ($subject->getTrainingPrograms() as $trainingProgram) {
                    foreach ($trainingProgram->getTrainingProgramGrades() as $trainingProgramGrade) {
                        if ($trainingProgramGrade?->getGrade()?->getTraining()?->getDepartment()?->getHead()?->getPerson()
                                === $user) {
                            return true;
                        }
