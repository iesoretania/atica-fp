...
{
    public const MANAGE = 'ITP_TRAVEL_EXPENSE_MANAGE';
    public const ACCESS = 'ITP_TRAVEL_EXPENSE_ACCESS';
    ...
    final public function voteOnAttribute($attribute, $subject, TokenInterface $token): bool
    {
        ...
        switch ($attribute) {
            case self::MANAGE:
                ...
                // o quien tenga permiso en sus planes formativos
                return ($subject->getTeacher()->getPerson() === $user
                    || $this->decisionManager->decide($token, [TeacherVoter::MANAGE_EXPENSE], $subject->getTeacher()))
            ...
            case self::ACCESS:
                ...
                if ($subject->getTeacher()->getPerson() === $user
                    || $this->decisionManager->decide($token, [TeacherVoter::ACCESS_EXPENSE], $subject->getTeacher())) {
                    return true;
                }
