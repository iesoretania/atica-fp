...
class Version20181119195625 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE edu_organization (organization_id INT NOT NULL, current_academic_year_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_9DECA13B2B06A9F7 (current_academic_year_id), PRIMARY KEY(organization_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci ENGINE = InnoDB');
