...
class Version20181203095752 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE wlt_activity_competency (activity_id INT NOT NULL, competency_id INT NOT NULL, INDEX IDX_39DDED3181C06096 (activity_id), INDEX IDX_39DDED31FB9F58C (competency_id), PRIMARY KEY(activity_id, competency_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE wlt_activity_realization (id INT AUTO_INCREMENT NOT NULL, activity_id INT NOT NULL, code VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_BA14088981C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
