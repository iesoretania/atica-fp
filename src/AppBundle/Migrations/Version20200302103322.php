...
class Version20200302103322 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE edu_criterion (id INT AUTO_INCREMENT NOT NULL, learning_outcome_id INT NOT NULL, code VARCHAR(255) DEFAULT NULL, name LONGTEXT NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_6A1D6D1335C2B2D5 (learning_outcome_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci ENGINE = InnoDB');
