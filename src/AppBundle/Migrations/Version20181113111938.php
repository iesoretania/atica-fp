 ...
 */
class Version20181113111938 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE edu_department (id INT AUTO_INCREMENT NOT NULL, head_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_6EB77EB1F41A619E (head_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
