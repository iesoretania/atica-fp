...
namespace AppBundle\Security\ICT;
...
{
    const MANAGE = 'ELEMENT_MANAGE';
    const ACCESS = 'ELEMENT_ACCESS';
    ...
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token)
    {
        ...
        if ($attribute === self::ACCESS) {
            ...
            foreach ($user->getMemberships() as $membership) {
                if ($membership->getOrganization() === $organization && $membership->getValidFrom() <= $date &&
