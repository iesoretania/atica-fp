...
{
    /**
     * @Route("/materia/{id}/resultado/nuevo", name="training_learning_outcome_new", methods={"GET", "POST"})
     **/
    ...
    public function formAction(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                ...
                return $this->redirectToRoute('training_learning_outcome_list', [
                    'id' => $subject->getId()
                ]);
            } catch (\Exception $e) {
        ...
        $breadcrumb = [
            ...
            [
                ...
                'routeName' => 'training_learning_outcome_list',
        ...
        return $this->render('training/learning_outcome_form.html.twig', [
            'menu_path' => 'training',
    ...
    /**
     * @Route("/materia/{id}/resultado/{page}/", name="training_learning_outcome_list",
    ...
    public function listAction(
        ...
        return $this->render('training/learning_outcome_list.html.twig', [
            'menu_path' => 'training',
            'breadcrumb' => $breadcrumb,
            'title' => $title,
            'pager' => $pager,
    ...
    /**
     * @Route("/materia/resultado/eliminar/{id}", name="training_learning_outcome_delete",
        ...
        Subject $subject)
    {
        ...
        if (count($items) === 0) {
            return $this->redirectToRoute('training_learning_outcome_list', ['id' => $subject->getId()]);
        }
        ...
        return $this->render('training/learning_outcome_delete.html.twig', [
            'menu_path' => 'training',
            'breadcrumb' => $breadcrumb,
