...
use App\Repository\WorkcenterRepository as WorkcenterRepositoryAlias;
use App\Repository\WptModule\AgreementRepository;
use App\Repository\WptModule\TeacherRepository as WptTeacherRepository;
use App\Repository\WptModule\WorkcenterRepository as WptWorkcenterRepository;
...
{
    public function __construct(private readonly WorkcenterRepositoryAlias $workcenterRepository, private readonly UserExtensionService $userExtensionService, private readonly WptTeacherRepository $wptTeacherRepository, private readonly AgreementRepository $agreementRepository, private readonly WptWorkcenterRepository $wptWorkcenterRepository)
    {
    }
