...
use App\Repository\WltModule\CompanyRepository;
...
{
    public function __construct(private readonly StudentEnrollmentRepository $studentEnrollmentRepository, private readonly WorkcenterRepository $workcenterRepository, private readonly CompanyRepository $wltCompanyRepository, private readonly ActivityRealizationRepository $activityRealizationRepository, private readonly TeacherRepository $teacherRepository)
    {
    }
