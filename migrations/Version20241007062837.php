...
final class Version20241007062837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE itp_program_grade_subject (program_grade_id INT NOT NULL, subject_id INT NOT NULL, INDEX IDX_F99BA6177F2C5D9D (program_grade_id), INDEX IDX_F99BA61723EDC87 (subject_id), PRIMARY KEY(program_grade_id, subject_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE itp_student_learning_program_activity (id INT AUTO_INCREMENT NOT NULL, activity_id INT NOT NULL, scale_value_id INT DEFAULT NULL, valued_by_id INT DEFAULT NULL, locked TINYINT(1) NOT NULL, details LONGTEXT DEFAULT NULL, INDEX IDX_3BF21E7E81C06096 (activity_id), INDEX IDX_3BF21E7E1B925809 (scale_value_id), INDEX IDX_3BF21E7E26F862F5 (valued_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE itp_student_learning_program_activity_audit (id INT NOT NULL, rev INT NOT NULL, activity_id INT DEFAULT NULL, scale_value_id INT DEFAULT NULL, valued_by_id INT DEFAULT NULL, locked TINYINT(1) DEFAULT NULL, details LONGTEXT DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_2726065f53799f1a554969312ee235b6_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
