 ...
 */
final class Version20240922173645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE itp_activity (id INT AUTO_INCREMENT NOT NULL, training_program_id INT NOT NULL, code VARCHAR(255) NOT NULL, name LONGTEXT NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_12216C8B8406BD6C (training_program_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE itp_activity_audit (id INT NOT NULL, rev INT NOT NULL, training_program_id INT DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, name LONGTEXT DEFAULT NULL, description LONGTEXT DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_ec81cce9357b10e123ad7a8a61086606_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE itp_company_program_audit (id INT NOT NULL, rev INT NOT NULL, training_program_id INT DEFAULT NULL, company_id INT DEFAULT NULL, agreement_number VARCHAR(255) DEFAULT NULL, monitoring_instruments LONGTEXT DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_2fa1ce202ffe5764db7e79671701410e_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE itp_training_program (id INT AUTO_INCREMENT NOT NULL, training_id INT NOT NULL, performance_scale_id INT NOT NULL, target_hours INT DEFAULT NULL, default_modality INT NOT NULL, INDEX IDX_AF5EDD7BBEFD98D1 (training_id), INDEX IDX_AF5EDD7B7C2C26C0 (performance_scale_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE itp_training_program_audit (id INT NOT NULL, rev INT NOT NULL, training_id INT DEFAULT NULL, performance_scale_id INT DEFAULT NULL, target_hours INT DEFAULT NULL, default_modality INT DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_8ae70b07fee7de0a9454869a1a3e11b9_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE itp_training_program_group (id INT AUTO_INCREMENT NOT NULL, training_program_id INT NOT NULL, group_id INT NOT NULL, locked TINYINT(1) NOT NULL, notes LONGTEXT DEFAULT NULL, modality INT NOT NULL, target_hours INT DEFAULT NULL, INDEX IDX_E8E8C7F8406BD6C (training_program_id), INDEX IDX_E8E8C7FFE54D947 (group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE itp_training_program_group_manager (training_program_group_id INT NOT NULL, teacher_id INT NOT NULL, INDEX IDX_2F200CB7CEDF9BEF (training_program_group_id), INDEX IDX_2F200CB741807E1D (teacher_id), PRIMARY KEY(training_program_group_id, teacher_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE itp_training_program_group_audit (id INT NOT NULL, rev INT NOT NULL, training_program_id INT DEFAULT NULL, group_id INT DEFAULT NULL, locked TINYINT(1) DEFAULT NULL, notes LONGTEXT DEFAULT NULL, modality INT DEFAULT NULL, target_hours INT DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_8b067c8bbb89d1e6a3ed9816c60dbe92_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE itp_training_program_group_manager_audit (training_program_group_id INT NOT NULL, teacher_id INT NOT NULL, rev INT NOT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_49e142fdaae7d616f4e7e17a24f844b8_idx (rev), PRIMARY KEY(training_program_group_id, teacher_id, rev)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
