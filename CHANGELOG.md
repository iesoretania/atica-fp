...
* fix: Evitar lanzar excepción cuando un usuario intenta acceder pero no pertenece al curso académico actual
...
* fix: No considerar tramos incompletos a la hora de calcular la duración de la jornada
* feat: Generación del informe de acreditación de asistencia de la FFE
...
* fix: Solucionado un problema al crear planes de formación nuevos
...
* feat: Las concreciones ya valoradas no pueden ser deshabilitadas
